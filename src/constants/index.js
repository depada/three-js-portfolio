...
export const workExperiences = [
  {
    ...
    title: 'Full-stack work across services and infra with measurable performance and reliability gains.',
    highlights: [
      'JDK 8→11 across 5 modules/14 services; deployments 2×, release success 92%→99.3%',
      'Custom annotations: −1.1k LOC (−24%) boilerplate; −28% duplicate defects',
      'API tuning: p50 −50%, p95 −43%, 2.2× throughput; −17% infra cost/request',
      'Post-deploy validator: 45m→11m, +35% early defect detection; adopted by 3 teams',
      'Resolved 40+ P2/P3; MTTR 2.4h→1.3h; authored 12 runbooks',
    ],
    icon: '/assets/acc.png',
    animation: 'victory',
  },
  {
    ...
    title: 'React Native apps with CRUD and basic state management.',
    highlights: ['Shipped todo and calculator apps; onboarded 100+ users', 'Stability work reduced crash rate by ~20%'],
  ...
  },
  {
    ...
    title: 'Web app with PostgreSQL and secure contact flow.',
    highlights: ['Built web-based todo with Postgres', 'Captcha integration cut spam by ~30%'],
    icon: '/assets/codeclause.png',
    animation: 'salute',
  },
];
